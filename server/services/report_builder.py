...
def _platform_credit_html() -> str:
    """Subtle 'generated by' credit on every landlord-issued PDF — never
    competes with the landlord's own letterhead above it (see _letterhead_html)."""
    return (
