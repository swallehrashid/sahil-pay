// ---------------------------------------------------------------------------
// SahilPay marketing SEO content bank
// ---------------------------------------------------------------------------
...
export const SEO_FAQ_CATEGORIES = [
  {
    ...
    questions: [
      { id: "what-is", q: "What is the best rental management software in Kenya?", a: "SahilPay is an all-in-one rental and property management platform built for Kenya — it combines M-Pesa rent collection, automated invoicing, a tenant portal, maintenance tracking, team permissions and financial reporting in one place, so landlords stop juggling spreadsheets and WhatsApp messages." },
      { id: "who-for", q: "Who is SahilPay for?", a: "Individual landlords, property managers, real-estate agencies and caretakers who manage anything from a single rental unit to thousands of units across many properties." },
      ...
      { id: "need-install", q: "Do I need to install anything or buy hardware?", a: "No. SahilPay is fully cloud-based and mobile-first — you and your tenants just need a phone or computer with a browser. There is nothing to install and no hardware to buy." },
      { id: "replace-spreadsheets", q: "Can property management software replace my spreadsheets?", a: "Yes. SahilPay replaces rent-tracking spreadsheets, paper receipts and scattered M-Pesa SMS with one live system where every unit, tenant, invoice and payment is always up to date and reconciled automatically." },
    ],
  },
  {
    category: "M-Pesa & payments",
    questions: [
      { id: "mpesa", q: "Does SahilPay support M-Pesa for rent collection?", a: "Yes — SahilPay is M-Pesa native. It supports both Paybill and Till (Buy Goods), STK push prompts, and automatic matching of incoming M-Pesa payments to the right tenant and invoice." },
      ...
      { id: "bank", q: "Can I reconcile bank statement payments too?", a: "Yes. Upload a bank statement and SahilPay reconciles the transactions against tenant invoices, so cheque, bank-transfer and cash-deposit rents are tracked alongside M-Pesa." },
      { id: "partial", q: "Can tenants pay rent in partial instalments?", a: "Yes. SahilPay handles partial payments, splits a single payment across multiple invoices, and always shows each tenant's exact running balance, arrears or credit." },
  ...
  },
  {
    ...
    questions: [
      { id: "auto-invoice", q: "Can I automate monthly rent invoices?", a: "Yes. Set rent once and SahilPay generates and sends monthly rent invoices automatically, including recurring utility charges and service fees, so you never have to raise them by hand." },
      { id: "utilities", q: "How do I bill tenants for water and electricity?", a: "Enter meter readings and SahilPay turns the consumption into utility line items on the tenant's invoice, using your per-unit rates — water, electricity, garbage and any custom charge." },
      { id: "penalties", q: "Can I charge late-payment penalties automatically?", a: "Yes. Configure penalty rules and SahilPay applies late fees to overdue invoices automatically, keeping arrears and penalties clearly itemised." },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "lifecycle", q: "Can I track a tenant's full history?", a: "Yes. SahilPay records the complete tenant lifecycle — move-in, unit transfers, lease terms, documents, payments and move-out — with a full shift history per unit." },
      { id: "lease-expiry", q: "Will I get alerts before a lease expires?", a: "Yes. SahilPay sends lease-expiry alerts ahead of time so you can renew, adjust rent or plan a vacancy before the unit becomes empty." },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "expenses", q: "Can I record property expenses and see profitability?", a: "Yes. Record one-off and recurring expenses per property, categorise them, and SahilPay nets them against rent collected to show real income and profitability." },
      ...
      { id: "vacancy", q: "How do I track occupancy and vacancy?", a: "SahilPay shows live occupancy and vacancy per property and across your portfolio, so you always know which units are earning and which are empty." },
    ],
  },
  {
    ...
    questions: [
      ...
      { id: "own-sender", q: "Can I send SMS from my own sender ID?", a: "Yes. Connect your own Africa's Talking sender ID to send under your brand, or use SahilPay's shared sender ID and simply top up SMS credits — you choose." },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "tax", q: "Does SahilPay help with rental income tax?", a: "Yes. Reports show rent collected, expenses and net income with a per-property tax rate, and you can download tax receipts and statements to file your rental income tax." },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "how-priced", q: "How much does rental management software cost in Kenya?", a: "SahilPay is priced per unit per month, so you only pay for what you manage. Small landlords pay little; larger portfolios get lower per-unit rates and custom pricing." },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "backup", q: "Does SahilPay back up my data?", a: "Yes. Your data is safely stored in the cloud and you can generate your own scoped backups whenever you want an offline copy." },
      ...
      { id: "kenya", q: "Is SahilPay built specifically for the Kenyan market?", a: "Yes. It's built around M-Pesa, KES currency, the Africa/Nairobi timezone and the way Kenyan landlords actually collect rent and communicate with tenants." },
    ],
  },
  {
    ...
    questions: [
      ...
      { id: "grow", q: "Will it scale as I add more units?", a: "Yes. SahilPay handles single landlords through to thousands of units, and your plan tier adjusts automatically as your portfolio grows." },
    ],
  },
];
