...
// Items without a `module` key are ungated (maintenance/groups/reports aren't part of
// the team_member_permissions vocabulary) — everything else is filtered by buildVisibleNav.
const NAV_ITEMS = [
  ...
  { to: TEAM_ROUTES.maintenance, label: "Maintenance", icon: <Wrench className="h-4 w-4" /> },
