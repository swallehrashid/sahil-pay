...
export const BRAND_IMAGE_SPECS = {
  ...
  letterhead: {
    ...
    hint: "Your designed letterhead. Replaces the generated name-and-address header on documents and emails.",
    accept: "image/png,image/jpeg,image/webp",
    formats: ["PNG", "JPG", "WebP"],
    maxBytes: 8 * 1024 * 1024,
    minWidth: 1000,
    idealWidth: "1600–2400px wide",
    minRatio: 3,
    maxRatio: 12,
    idealRatio: "between 4:1 and 8:1 (a wide banner)",
    requirements: [
      "PNG, JPG or WebP — under 8 MB.",
      "A wide banner: 4:1 to 8:1, the top strip of your printed letterhead only — not a whole A4 page.",
      "At least 1000px wide; 1600–2400px prints crisply across the page.",
      "It is drawn up to 110px tall on documents and 560px wide in emails, so keep the text large.",
      "Leave it empty to use your logo, company name and address instead — that also looks professional.",
    ],
  },
  signature: {
    label: "Signature",
