...
// as "welcome to your brand-new account" for someone who's been using SahilPay for months.
export default function WelcomeModal({ isOpen, isReturning, onStart, onSkip }) {
  return (
    <Modal isOpen={isOpen} onClose={onSkip} title={isReturning ? "Take a quick tour of SahilPay" : "Welcome to SahilPay 👋"} size="sm">
