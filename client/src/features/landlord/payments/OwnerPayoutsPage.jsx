...
export default function OwnerPayoutsPage({ properties = [] }) {
  ...
  return (
    <div className="animate-fade-in-up space-y-6">
      {/* The page title belongs to PayoutsLayout, which wraps both tabs — this
          is the tab's own standfirst, not a second <h1>. */}
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <p className="max-w-2xl text-sm leading-relaxed text-white/50">
            Every remittance to a property's owner — those generated by a payout
            run, and any sent outside one (an advance, a correction, last year's
            arrears). These appear on the property statement as "Remitted to
            owner"; they are not expenses and never affect tax or commission.
          </p>
        </div>
